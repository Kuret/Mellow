...
class AppliedTombstone extends Table
    with TableInfo<AppliedTombstone, AppliedTombstoneData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AppliedTombstoneData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class AppliedTombstoneData extends DataClass
    implements Insertable<AppliedTombstoneData> {
  final String id;
  final int appliedAt;
  ...
  AppliedTombstoneData copyWith({String? id, int? appliedAt}) =>
      AppliedTombstoneData(
        id: id ?? this.id,
        appliedAt: appliedAt ?? this.appliedAt,
      );
  AppliedTombstoneData copyWithCompanion(AppliedTombstoneCompanion data) {
    return AppliedTombstoneData(
      id: data.id.present ? data.id.value : this.id,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AppliedTombstoneData &&
          other.id == this.id &&
          other.appliedAt == this.appliedAt);
}

class AppliedTombstoneCompanion extends UpdateCompanion<AppliedTombstoneData> {
  final Value<String> id;
  ...
  static Insertable<AppliedTombstoneData> custom({
    Expression<String>? id,
  ...
  AppliedTombstoneCompanion copyWith({
    Value<String>? id,
    Value<int>? appliedAt,
    Value<int>? rowid,
  }) {
    return AppliedTombstoneCompanion(
      id: id ?? this.id,
      appliedAt: appliedAt ?? this.appliedAt,
      rowid: rowid ?? this.rowid,
    );
...
class PendingEngineClose extends Table
    with TableInfo<PendingEngineClose, PendingEngineCloseData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  List<GeneratedColumn> get $columns => [engineTabId, requestedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {engineTabId};
  @override
  PendingEngineCloseData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class PendingEngineCloseData extends DataClass
    implements Insertable<PendingEngineCloseData> {
  final String engineTabId;
  ...
  PendingEngineCloseData copyWith({String? engineTabId, int? requestedAt}) =>
      PendingEngineCloseData(
        engineTabId: engineTabId ?? this.engineTabId,
        requestedAt: requestedAt ?? this.requestedAt,
      );
  PendingEngineCloseData copyWithCompanion(PendingEngineCloseCompanion data) {
    return PendingEngineCloseData(
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PendingEngineCloseData &&
          other.engineTabId == this.engineTabId &&
          other.requestedAt == this.requestedAt);
}

class PendingEngineCloseCompanion
    extends UpdateCompanion<PendingEngineCloseData> {
  final Value<String> engineTabId;
  ...
  PendingEngineCloseCompanion.insert({
    ...
    this.rowid = const Value.absent(),
  }) : engineTabId = Value(engineTabId),
       requestedAt = Value(requestedAt);
  static Insertable<PendingEngineCloseData> custom({
    Expression<String>? engineTabId,
  ...
  PendingEngineCloseCompanion copyWith({
    Value<String>? engineTabId,
    Value<int>? requestedAt,
    Value<int>? rowid,
  }) {
    return PendingEngineCloseCompanion(
      engineTabId: engineTabId ?? this.engineTabId,
      requestedAt: requestedAt ?? this.requestedAt,
      rowid: rowid ?? this.rowid,
    );
...
class DatabaseAtV20 extends GeneratedDatabase {
  ...
  late final AppliedTombstone appliedTombstone = AppliedTombstone(this);
  late final PendingEngineClose pendingEngineClose = PendingEngineClose(this);
  @override
