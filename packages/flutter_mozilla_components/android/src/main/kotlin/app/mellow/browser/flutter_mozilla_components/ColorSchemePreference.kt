 ...
 * run in a native, non-Flutter activity ([app.mellow.browser.flutter_mozilla_components.activities.ExternalAppBrowserActivity]).
...
object ColorSchemePreference {
    private const val PREF_KEY = "mellow_preferred_color_scheme"
     ...
     * Custom Tab / PWA launch). Must match Mellow's default app theme
     ...
     * selected in Mellow, instead of always following the system. This avoids the
     * window flashing dark before the page paints when Mellow is forced to light.
     */
